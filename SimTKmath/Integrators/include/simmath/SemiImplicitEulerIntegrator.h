#ifndef SimTK_SIMMATH_SEMI_IMPLICIT_EULER_INTEGRATOR_H_
...
class SemiImplicitEulerIntegratorRep;

/** This is an implementation of the Semi-Implicit Euler method, also
known as Symplectic Euler, where we treat the velocity equations implicitly and
the position equations explicitly.
...
class SimTK_SIMMATH_EXPORT SemiImplicitEulerIntegrator : public Integrator {
public:
    /** Create a SemiImplicitEulerIntegrator for integrating a System with 
    fixed size steps. **/
    SemiImplicitEulerIntegrator(const System& sys, Real stepSize);
};

} // namespace SimTK

#endif // SimTK_SIMMATH_SEMI_IMPLICIT_EULER_INTEGRATOR_H_
