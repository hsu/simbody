...
#include "simmath/SemiImplicitEulerIntegrator.h"

#include "IntegratorRep.h"
#include "SemiImplicitEulerIntegratorRep.h"
...
SemiImplicitEulerIntegrator::SemiImplicitEulerIntegrator
   (const System& sys, Real stepSize) {
    rep = new SemiImplicitEulerIntegratorRep(this, sys);
...
//==============================================================================
SemiImplicitEulerIntegratorRep::SemiImplicitEulerIntegratorRep
   (Integrator* handle, const System& sys)
:   AbstractIntegratorRep(handle, sys, 1, 1, "SemiImplicitEuler",  false) 
{
}
...
void SemiImplicitEulerIntegratorRep::createInterpolatedState(Real t) {
...
void SemiImplicitEulerIntegratorRep::
...
//                            ATTEMPT DAE STEP
//==============================================================================
// Note that SemiImplicitEuler overrides the entire DAE step because it can't 
// use the default ODE-then-DAE structure. Instead the constraint projections 
// are interwoven here.
bool SemiImplicitEulerIntegratorRep::attemptDAEStep
